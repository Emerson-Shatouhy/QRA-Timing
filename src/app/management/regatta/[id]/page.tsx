  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      <div className="max-w-5xl mx-auto px-6 py-8">
        {/* Breadcrumb */}
        <Link href="/management" className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 mb-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm mb-6">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href={`/management/regatta/${regattaId}/schedule`}>
            ...
            {races.map((race) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Main info */}
                  <Link href={`/management/race/${race.id}`} className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-500">
                    ...
                    <Link href={`/management/race/${race.id}`}>
